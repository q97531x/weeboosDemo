...
public class ContainerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getChildFragmentManager().beginTransaction().replace(R.id.fl_1,OneFragment.newInstance("1", "1")).commit();
        getChildFragmentManager().beginTransaction().replace(R.id.fl_2,TwoFragment.newInstance("2", "2")).commit();
